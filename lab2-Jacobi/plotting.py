...
def plot():
    ...
    for filename in filenames:
        ...
        for run_result in run_results['runs']:
            thread_num = f'{run_result["thread_num"]} cores(s)'
    ...
    for line_label, runtimes_for_size in sorted(run_times_for_sizes.items()):
        ...
        speedups = [run_times_for_sizes['1 cores(s)'][i][1] / x[1] for i, x in enumerate(runtimes_for_size)]
    ...
    plt.savefig('./images/jacobi_1.png', bbox_extra_artists=(lgd, ), bbox_inches='tight')
